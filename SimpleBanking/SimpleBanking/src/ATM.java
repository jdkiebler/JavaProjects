...
public class ATM {
    ...
    public static void main(String[] args) {
        ...
        Bank theBank = new Bank("Eighth-Second Bank");

        User aUser = theBank.addUser("Derek", "Sanderson", "8309");
    ...
    public static void printUserMenu(User theUser, Scanner sc) {
        ...
        do {
            System.out.printf("Welcome %s! Please make a selection from the following options: \n", theUser.getFirstName());
